...
public class FloatingModMenuService extends Service {
    ...
    int TEXT_COLOR_3 = Color.parseColor("#ffffff");
    int TEXT_COLOR_4 = Color.parseColor("#82CAFD");
    int TEXT_COLOR_5 = Color.parseColor("#ffffff");
    ...
    float ICON_ALPHA = 1f;//0.7f; //Transparent
    int ToggleON = Color.parseColor("#3ba55d");
    int ToggleOFF = Color.parseColor("#72767d");
    int BtnON = Color.parseColor("#36393f");
    int BtnOFF = Color.parseColor("#36393f");
    ...
    private void initFloating() {
        ...
        mExpanded.setPadding(4, 1, 1, 1); //So borders would be visible
        ...
        gdMenuBody.setStroke(8, Color.parseColor("#202225")); //Set border
        ...
        heading.setTextColor(TEXT_COLOR_4);
        ...
        hideBtn.setTextColor(TEXT_COLOR_3);
        ...
        closeBtn.setTextColor(TEXT_COLOR_3);
    ...
    private View ButtonOnOff(final int featNum, String featName, boolean switchedOn) {
        ...
        if (isOn) {
            button.setText(Html.fromHtml(finalfeatName + "<br>[ Status : <font color='green'>ON</font> ]"));
            button.setBackgroundColor(BtnON);
            isOn = false;
        } else {
            button.setText(Html.fromHtml(finalfeatName + "<br>[ Status : <font color='red'>OFF</font> ]"));
    ...
    private void Collapse(LinearLayout linLayout, final String text) {
        ...
        collapseSub.setBackgroundColor(Color.parseColor("#202225"));
        collapseSub.setVisibility(View.GONE);
        mCollapse = collapseSub;

        final TextView textView = new TextView(this);
        textView.setBackgroundColor(CategoryBG);
        textView.setText(Html.fromHtml("" + text + "<br>[ Status : <font color='red'>Closed</font> ]<br>( Click To Open )"));
        textView.setGravity(Gravity.CENTER);
        textView.setTextColor(TEXT_COLOR_5);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (z) {
                    ...
                    textView.setText(Html.fromHtml("" + text + "<br>[ Status : <font color='green'>Open</font> ]"));
                    return;
                }
                collapseSub.setVisibility(View.GONE);
                textView.setText(Html.fromHtml("" + text + "<br>[ Status : <font color='red'>Closed</font> ]"));
            }
        });
